...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      // Fixed: call sequentially to avoid Future.wait type mismatch
                  ...
                  Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            'Namaste, ${_farmer?.name.split(' ').first ?? ''}! 🌾',
  ...
  Widget _buildAlertBanner() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color:
            isHighRisk ? const Color(0xFFFFEBEE) : const Color(0xFFFFF3E0),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  isHighRisk ? '⚡ Payout Triggered!' : '⚠️ Disease Detected',
                  style: TextStyle(
                    fontWeight: FontWeight.bold,
                    color: isHighRisk
                        ? const Color(0xFFEF5350)
                ...
                Text(
                  '${p.diseaseType.replaceAll('_', ' ').toUpperCase()} — ${(p.confidenceScore * 100).toInt()}% confidence',
                  style: const TextStyle(
